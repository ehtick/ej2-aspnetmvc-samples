...
public class RowSpanItem
{
    ...
    public string MaterialStockRemaining { get; set; }
    public List<RowSpanItem> Children { get; set; }
    public RowSpanItem() { Children = new List<RowSpanItem>(); }

    public static List<RowSpanItem> GetRowSpanData()
    {
        return new List<RowSpanItem>
    {
        new RowSpanItem
        {
            ActivityName = "Tower",
            ...
            Children = new List<RowSpanItem>
            {
                new RowSpanItem
                {
                    ...
                    CostCode = "02-01-00",
                    PermitStatus = "Issued",
                    InspectionDate = new DateTime(2025, 08, 16),
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Architectural Design Task", LevelId = "L3-001", StartDate = new DateTime(2025,07,02), EndDate = new DateTime(2025,07,10), InspectionDate = new DateTime(2025,07,11), Status = "Scheduled", Progress = 100, TotalBudget = 100000m, PaidToDate = 0m, Supervisor = "David Lin", Team = "Architecture Unit", PermitStatus = "Scheduled", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-TWR-ARC-TSK", MaterialUsed = "CAD Drawings", MaterialCost = 15000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Structural Design Task", LevelId = "L3-002", StartDate = new DateTime(2025,07,11), EndDate = new DateTime(2025,07,25), InspectionDate = new DateTime(2025,07,26), Status = "Scheduled", Progress = 100, TotalBudget = 120000m, PaidToDate = 0m, Supervisor = "Sarah Patel", Team = "Structural Unit", PermitStatus = "Scheduled", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-TWR-STR-TSK", MaterialUsed = "Structural Plans", MaterialCost = 15000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "MEP Design Task", LevelId = "L3-003", StartDate = new DateTime(2025,07,26), EndDate = new DateTime(2025,08,15), InspectionDate = new DateTime(2025,08,16), Status = "Scheduled", Progress = 100, TotalBudget = 100000m, PaidToDate = 0m, Supervisor = "Carlos Rivera", Team = "MEP Unit", PermitStatus = "Scheduled", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-TWR-MEP-TSK", MaterialUsed = "Electrical Schematics", MaterialCost = 20000m, MaterialStockRemaining = "N/A" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ...
                    LevelId = "L2-002",
                    StartDate = new DateTime(2025, 08, 16),
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Foundation Construction Task", LevelId = "L3-004", StartDate = new DateTime(2025,08,16), EndDate = new DateTime(2025,08,25), InspectionDate = new DateTime(2025,08,26), Status = "Completed", Progress = 100, TotalBudget = 305000m, PaidToDate = 350000m, Supervisor = "Robert Singh", Team = "Foundation Crew", PermitStatus = "Approved", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-TWR-FND-TSK", MaterialUsed = "Concrete", MaterialCost = 15000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Structural Construction Task", LevelId = "L3-005", StartDate = new DateTime(2025,08,26), EndDate = new DateTime(2025,09,20), InspectionDate = new DateTime(2025,09,21), Status = "In Progress", Progress = 80, TotalBudget = 300000m, PaidToDate = 240000m, Supervisor = "Nathan Blake", Team = "Structural Team", PermitStatus = "Approved", InspectionStatus = "Passed with Notes", FollowUpActions = "Reinforce beams", InspectionCost = 100m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-STR-TSK", MaterialUsed = "Steel Beams", MaterialCost = 20000m, MaterialStockRemaining = "200 tons" },
                        new RowSpanItem { ActivityName = "Exterior Construction Task", LevelId = "L3-006", StartDate = new DateTime(2025,09,21), EndDate = new DateTime(2025,10,20), InspectionDate = new DateTime(2025,10,21), Status = "In Progress", Progress = 40, TotalBudget = 300000m, PaidToDate = 120000m, Supervisor = "Thomas Reed", Team = "Exterior Crew", PermitStatus = "Approved", InspectionStatus = "Passed with Notes", FollowUpActions = "Continue exterior work", InspectionCost = 100m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-EXT-TSK", MaterialUsed = "Metal Panels", MaterialCost = 15000m, MaterialStockRemaining = "300 panels" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ...
                    EndDate = new DateTime(2025, 11, 05),
                    ...
                    CostCode = "04-01-00",
                    PermitStatus = "Issued",
                    InspectionDate = new DateTime(2025, 11, 06),
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "OSHA Compliance Task", LevelId = "L3-007", StartDate = new DateTime(2025,10,21), EndDate = new DateTime(2025,10,27), InspectionDate = new DateTime(2025,10,28), Status = "In Progress", Progress = 70, TotalBudget = 20000m, PaidToDate = 14000m, Supervisor = "Laura Bennett", Team = "Safety Inspectors", PermitStatus = "Issued", InspectionStatus = "In Progress", FollowUpActions = "Complete briefing", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-OSHA-TSK", MaterialUsed = "Safety Gear", MaterialCost = 4000m, MaterialStockRemaining = "40 helmets" },
                        new RowSpanItem { ActivityName = "Fire Safety Task", LevelId = "L3-008", StartDate = new DateTime(2025,10,28), EndDate = new DateTime(2025,11,01), InspectionDate = new DateTime(2025,11,02), Status = "Scheduled", Progress = 30, TotalBudget = 15000m, PaidToDate = 0m, Supervisor = "Melissa Tran", Team = "Fire Safety Team", PermitStatus = "Issued", InspectionStatus = "Scheduled", FollowUpActions = "Install exits", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-FIRE-TSK", MaterialUsed = "Extinguishers", MaterialCost = 3000m, MaterialStockRemaining = "15 units" },
                        new RowSpanItem { ActivityName = "Structural Audit Task", LevelId = "L3-009", StartDate = new DateTime(2025,11,02), EndDate = new DateTime(2025,11,05), InspectionDate = new DateTime(2025,11,06), Status = "Scheduled", Progress = 20, TotalBudget = 15000m, PaidToDate = 0m, Supervisor = "David Lin", Team = "Audit Engineers", PermitStatus = "Issued", InspectionStatus = "Scheduled", FollowUpActions = "Verify integrity", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-AUD-TSK", MaterialUsed = "Inspection Tools", MaterialCost = 3000m, MaterialStockRemaining = "N/A" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ...
                    LevelId = "L2-004",
                    StartDate = new DateTime(2025, 11, 06),
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Interior Drywall Task", LevelId = "L3-010", StartDate = new DateTime(2025,11,06), EndDate = new DateTime(2025,11,20), InspectionDate = new DateTime(2025,11,21), Status = "In Progress", Progress = 50, TotalBudget = 80000m, PaidToDate = 40000m, Supervisor = "Hannah Kim", Team = "Drywall Crew", PermitStatus = "Issued", InspectionStatus = "In Progress", FollowUpActions = "Check alignment", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-DRY-TSK", MaterialUsed = "Drywall Sheets", MaterialCost = 8000m, MaterialStockRemaining = "150 panels" },
                        new RowSpanItem { ActivityName = "Flooring Installation Task", LevelId = "L3-011", StartDate = new DateTime(2025,11,21), EndDate = new DateTime(2025,12,01), InspectionDate = new DateTime(2025,12,02), Status = "Scheduled", Progress = 10, TotalBudget = 80000m, PaidToDate = 0m, Supervisor = "Sarah Patel", Team = "Flooring Team", PermitStatus = "Issued", InspectionStatus = "Scheduled", FollowUpActions = "Verify level", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-FLR-TSM", MaterialUsed = "Concrete Flooring", MaterialCost = 10000m, MaterialStockRemaining = "200 bags" },
                        new RowSpanItem { ActivityName = "Fixture Setup Task", LevelId = "L3-012", StartDate = new DateTime(2025,12,02), EndDate = new DateTime(2025,12,10), InspectionDate = new DateTime(2025,12,11), Status = "Scheduled", Progress = 10, TotalBudget = 90000m, PaidToDate = 0m, Supervisor = "Lucas Nguyen", Team = "Fit-Out Crew", PermitStatus = "Issued", InspectionStatus = "Scheduled", FollowUpActions = "Install fixtures", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-TWR-FIX-TSK", MaterialUsed = "Lighting Fixtures", MaterialCost = 7000m, MaterialStockRemaining = "50 units" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Punch List Review Task", LevelId = "L3-013", StartDate = new DateTime(2025,12,11), EndDate = new DateTime(2025,12,15), InspectionDate = new DateTime(2025,12,16), Status = "Scheduled", Progress = 20, TotalBudget = 15000m, PaidToDate = 0m, Supervisor = "John Carter", Team = "Closeout Team", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Resolve issues", InspectionCost = 0m, PunchListStatus = "Pending", DocumentReference = "DOC-TWR-PLR-TSK", MaterialUsed = "Punch List Forms", MaterialCost = 2000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Final Documentation Task", LevelId = "L3-014", StartDate = new DateTime(2025,12,16), EndDate = new DateTime(2025,12,22), InspectionDate = new DateTime(2025,12,23), Status = "Scheduled", Progress = 20, TotalBudget = 15000m, PaidToDate = 0m, Supervisor = "Emily Foster", Team = "Documentation Team", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Prepare reports", InspectionCost = 0m, PunchListStatus = "Pending", DocumentReference = "DOC-TWR-FD-TSK", MaterialUsed = "As-Built Drawings", MaterialCost = 2000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Client Handover Task", LevelId = "L3-015", StartDate = new DateTime(2025,12,23), EndDate = new DateTime(2025,12,29), InspectionDate = new DateTime(2025,12,30), Status = "Scheduled", Progress = 20, TotalBudget = 20000m, PaidToDate = 0m, Supervisor = "Emma Wilson", Team = "Client Relations", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Conduct walkthrough", InspectionCost = 0m, PunchListStatus = "Pending", DocumentReference = "DOC-TWR-CH-TSK", MaterialUsed = "Handover Kits", MaterialCost = 1000m, MaterialStockRemaining = "Delivered" }
                    }
                }
            }
        },
        ...
        new RowSpanItem
        {
            ...
            Children = new List<RowSpanItem>
            {
                new RowSpanItem
                {
                    ...
                    CostCode = "02-01-00",
                    PermitStatus = "Issued",
                    InspectionDate = new DateTime(2025, 09, 11),
                    InspectionStatus = "Passed",
                    FollowUpActions = "None",
                    InspectionCost = 300m,
                    PunchListStatus = "Cleared",
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Architectural Design Task", LevelId = "L3-046", StartDate = new DateTime(2025,08,02), EndDate = new DateTime(2025,08,12), InspectionDate = new DateTime(2025,08,13), Status = "Completed", Progress = 100, TotalBudget = 70000m, PaidToDate = 70200m, Supervisor = "David Lin", Team = "Architecture Unit", PermitStatus = "Approved", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-WH-ARC-TSK", MaterialUsed = "CAD Drawings", MaterialCost = 10000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Structural Design Task", LevelId = "L3-047", StartDate = new DateTime(2025,08,13), EndDate = new DateTime(2025,08,28), InspectionDate = new DateTime(2025,08,29), Status = "Completed", Progress = 100, TotalBudget = 72000m, PaidToDate = 70000m, Supervisor = "Sarah Patel", Team = "Structural Unit", PermitStatus = "Approved", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-WH-STR-TSK", MaterialUsed = "Structural Plans", MaterialCost = 10000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "MEP Design Task", LevelId = "L3-048", StartDate = new DateTime(2025,08,29), EndDate = new DateTime(2025,09,10), InspectionDate = new DateTime(2025,09,11), Status = "Completed", Progress = 100, TotalBudget = 62000m, PaidToDate = 60000m, Supervisor = "Carlos Rivera", Team = "MEP Unit", PermitStatus = "Approved", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-WH-MEP-TSK", MaterialUsed = "Electrical Schematics", MaterialCost = 10000m, MaterialStockRemaining = "N/A" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ActivityName = "Construction Stage",
                    LevelId = "L2-017",
                    StartDate = new DateTime(2025, 09, 11),
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "Foundation Construction Task", LevelId = "L3-049", StartDate = new DateTime(2025,09,11), EndDate = new DateTime(2025,09,25), InspectionDate = new DateTime(2025,09,26), Status = "Completed", Progress = 100, TotalBudget = 300000m, PaidToDate = 320000m, Supervisor = "Robert Singh", Team = "Foundation Crew", PermitStatus = "Approved", InspectionStatus = "Passed", FollowUpActions = "None", InspectionCost = 100m, PunchListStatus = "Cleared", DocumentReference = "DOC-WH-FND-TSK", MaterialUsed = "Concrete Mix", MaterialCost = 80000m, MaterialStockRemaining = "N/A" },
                        new RowSpanItem { ActivityName = "Framing Construction Task", LevelId = "L3-050", StartDate = new DateTime(2025,09,26), EndDate = new DateTime(2025,10,25), InspectionDate = new DateTime(2025,10,26), Status = "In Progress", Progress = 60, TotalBudget = 300000m, PaidToDate = 180000m, Supervisor = "Angela Moore", Team = "Structural Crew", PermitStatus = "Approved", InspectionStatus = "Passed with Notes", FollowUpActions = "Continue framing", InspectionCost = 200m, PunchListStatus = "Open", DocumentReference = "DOC-WH-FRM-TSK", MaterialUsed = "Steel Beams", MaterialCost = 60000m, MaterialStockRemaining = "200 tons" },
                        new RowSpanItem { ActivityName = "Exterior Construction Task", LevelId = "L3-051", StartDate = new DateTime(2025,10,26), EndDate = new DateTime(2025,11,20), InspectionDate = new DateTime(2025,11,21), Status = "In Progress", Progress = 20, TotalBudget = 200000m, PaidToDate = 40000m, Supervisor = "Thomas Reed", Team = "Exterior Crew", PermitStatus = "Issued", InspectionStatus = "In Progress", FollowUpActions = "Continue exterior work", InspectionCost = 0m, PunchListStatus = "Open", DocumentReference = "DOC-WH-EXT-TSK", MaterialUsed = "Metal Panels", MaterialCost = 60000m, MaterialStockRemaining = "300 panels" }
                    }
                },
                ...
                new RowSpanItem
                {
                    ...
                    Children = new List<RowSpanItem>
                    {
                        new RowSpanItem { ActivityName = "OSHA Compliance Task", LevelId = "L3-052", StartDate = new DateTime(2025,11,21), EndDate = new DateTime(2025,11,28), InspectionDate = new DateTime(2025,11,29), Status = "Scheduled", Progress = 30, TotalBudget = 10000m, PaidToDate = 0m, Supervisor = "Laura Bennett", Team = "Safety Inspectors", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Conduct briefing", InspectionCost = 0m, PunchListStatus = "Not Started", DocumentReference = "DOC-WH-OSHA-TSK", MaterialUsed = "Safety Gear", MaterialCost = 2000m, MaterialStockRemaining = "40 helmets" },
                        new RowSpanItem { ActivityName = "Fire Safety Task", LevelId = "L3-053", StartDate = new DateTime(2025,11,29), EndDate = new DateTime(2025,12,05), InspectionDate = new DateTime(2025,12,06), Status = "Scheduled", Progress = 20, TotalBudget = 10000m, PaidToDate = 0m, Supervisor = "Melissa Tran", Team = "Fire Safety Team", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Install exits", InspectionCost = 0m, PunchListStatus = "Not Started", DocumentReference = "DOC-WH-FIRE-TSK", MaterialUsed = "Extinguishers", MaterialCost = 1500m, MaterialStockRemaining = "15 units" },
                        new RowSpanItem { ActivityName = "Structural Audit Task", LevelId = "L3-054", StartDate = new DateTime(2025,12,06), EndDate = new DateTime(2025,12,10), InspectionDate = new DateTime(2025,12,11), Status = "Scheduled", Progress = 20, TotalBudget = 10000m, PaidToDate = 0m, Supervisor = "David Lin", Team = "Audit Engineers", PermitStatus = "Scheduled", InspectionStatus = "Not Started", FollowUpActions = "Verify integrity", InspectionCost = 0m, PunchListStatus = "Not Started", DocumentReference = "DOC-WH-AUD-TSK", MaterialUsed = "Inspection Tools", MaterialCost = 1500m, MaterialStockRemaining = "N/A" }
                    }
                }
            }
        }
...
public class WrapTask
{
    ...
    public List<WrapTask> Subtasks { get; set; }
    public WrapTask() { Subtasks = new List<WrapTask>(); }

    public static List<WrapTask> GetWrapData()
    {
        return new List<WrapTask>
    {
        new WrapTask
        {
            TaskID = 1001,
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1002, TaskName = "Define Project Scope", StartDate = new DateTime(2025,1,6), EndDate = new DateTime(2025,1,8), Duration = 3, Progress = 100, Priority = "Critical", Approved = true, Designation = "Business Analyst", EmployeeID = 5002, EmployeeName = "Nancy Davolio", Status = "Completed", Description = "Documented clear project boundaries and deliverables with full stakeholder agreement." },
                new WrapTask { TaskID = 1003, TaskName = "Create Risk Register", StartDate = new DateTime(2025,1,7), EndDate = new DateTime(2025,1,9), Duration = 3, Progress = 100, Priority = "High", Approved = true, Designation = "Risk Manager", EmployeeID = 5003, EmployeeName = "Andrew Fuller", Status = "Completed", Description = "Identified potential risks and defined mitigation strategies early in the project." },
                new WrapTask { TaskID = 1004, TaskName = "Team Onboarding Session", StartDate = new DateTime(2025,1,10), EndDate = new DateTime(2025,1,11), Duration = 1, Progress = 100, Priority = "Normal", Approved = true, Designation = "HR Lead", EmployeeID = 5004, EmployeeName = "Janet Leverling", Status = "Completed", Description = "Introduced team members and established communication protocols and collaboration tools." },
                new WrapTask { TaskID = 1005, TaskName = "Initiation Phase Sign-off", StartDate = new DateTime(2025,1,17), EndDate = new DateTime(2025,1,17), Duration = 0, Progress = 100, Priority = "Normal", Approved = true, Designation = "Project Sponsor", EmployeeID = 5005, EmployeeName = "Laura Callahan", Status = "Completed", Description = "Obtained official approval to proceed to the planning phase." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1007, TaskName = "Work Breakdown Structure", StartDate = new DateTime(2025,1,20), EndDate = new DateTime(2025,1,24), Duration = 5, Progress = 100, Priority = "High", Approved = true, Designation = "Planner", EmployeeID = 5007, EmployeeName = "Steven Gray", Status = "Completed", Description = "Broke down the project into manageable tasks and work packages." },
                new WrapTask { TaskID = 1008, TaskName = "Estimate Task Durations", StartDate = new DateTime(2025,1,23), EndDate = new DateTime(2025,1,27), Duration = 5, Progress = 100, Priority = "Normal", Approved = true, Designation = "Senior Developer", EmployeeID = 5008, EmployeeName = "Robert King", Status = "Completed", Description = "Used historical data and expert judgment to predict realistic task durations." },
                new WrapTask { TaskID = 1009, TaskName = "Assign Resource Roles", StartDate = new DateTime(2025,1,28), EndDate = new DateTime(2025,1,31), Duration = 4, Progress = 100, Priority = "Critical", Approved = true, Designation = "Resource Manager", EmployeeID = 5009, EmployeeName = "Anne Dodsworth", Status = "Completed", Description = "Matched team members’ skills to specific project roles and responsibilities." },
                new WrapTask { TaskID = 1010, TaskName = "Build Project Schedule", StartDate = new DateTime(2025,2,3), EndDate = new DateTime(2025,2,7), Duration = 5, Progress = 60, Priority = "High", Approved = false, Designation = "Scheduler", EmployeeID = 5010, EmployeeName = "David William", Status = "In Progress", Description = "Created a detailed Gantt chart with task dependencies, critical path, and milestones." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1012, TaskName = "Define System Components", StartDate = new DateTime(2025,2,10), EndDate = new DateTime(2025,2,14), Duration = 5, Progress = 100, Priority = "High", Approved = true, Designation = "Architect", EmployeeID = 5012, EmployeeName = "Steven Buchanan", Status = "Completed", Description = "Identified all required modules, services, and integration points." },
                new WrapTask { TaskID = 1013, TaskName = "Design Database Schema", StartDate = new DateTime(2025,2,17), EndDate = new DateTime(2025,2,21), Duration = 5, Progress = 100, Priority = "Critical", Approved = true, Designation = "DBA", EmployeeID = 5013, EmployeeName = "Laura Callahan", Status = "Completed", Description = "Designed a normalized relational database model with optimal indexing strategy." },
                new WrapTask { TaskID = 1014, TaskName = "API Design & Review", StartDate = new DateTime(2025,2,24), EndDate = new DateTime(2025,2,28), Duration = 5, Progress = 80, Priority = "High", Approved = false, Designation = "API Lead", EmployeeID = 5014, EmployeeName = "Michael Suyama", Status = "In Progress", Description = "Finalized RESTful API endpoints, contracts, versioning, and authentication methods." },
                new WrapTask { TaskID = 1015, TaskName = "UI/UX Wireframes & Mockups", StartDate = new DateTime(2025,2,24), EndDate = new DateTime(2025,3,7), Duration = 10, Progress = 50, Priority = "Normal", Approved = false, Designation = "UX Designer", EmployeeID = 5015, EmployeeName = "Nancy Davolio", Status = "In Progress", Description = "Created high-fidelity wireframes and interactive prototypes for the user interface." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1017, TaskName = "Set Up Project Structure", StartDate = new DateTime(2025,3,10), EndDate = new DateTime(2025,3,12), Duration = 3, Progress = 100, Priority = "Normal", Approved = true, Designation = "DevOps", EmployeeID = 5017, EmployeeName = "Janet Leverling", Status = "Completed", Description = "Initialized the repository with proper folder structure and tooling." },
                new WrapTask { TaskID = 1018, TaskName = "Create Login Page", StartDate = new DateTime(2025,3,13), EndDate = new DateTime(2025,3,18), Duration = 6, Progress = 100, Priority = "High", Approved = true, Designation = "Frontend Dev", EmployeeID = 5018, EmployeeName = "Robert King", Status = "Completed", Description = "Implemented secure login with form validation, OAuth, and password recovery." },
                new WrapTask { TaskID = 1019, TaskName = "Build Dashboard View", StartDate = new DateTime(2025,3,19), EndDate = new DateTime(2025,3,28), Duration = 8, Progress = 90, Priority = "Critical", Approved = false, Designation = "Senior Developer", EmployeeID = 5019, EmployeeName = "Anne Dodsworth", Status = "In Progress", Description = "Developed the main dashboard with real-time data visualization widgets." },
                new WrapTask { TaskID = 1020, TaskName = "Implement Navigation Menu", StartDate = new DateTime(2025,3,31), EndDate = new DateTime(2025,4,4), Duration = 5, Progress = 70, Priority = "Normal", Approved = false, Designation = "Frontend Dev", EmployeeID = 5020, EmployeeName = "David William", Status = "In Progress", Description = "Created a responsive sidebar and top navigation system with role-based access." },
                new WrapTask { TaskID = 1021, TaskName = "Add Form Components", StartDate = new DateTime(2025,4,7), EndDate = new DateTime(2025,4,18), Duration = 10, Progress = 30, Priority = "High", Approved = false, Designation = "UI Engineer", EmployeeID = 5021, EmployeeName = "Margaret Peacock", Status = "In Progress", Description = "Built reusable form components with validation, accessibility, and theming support." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1023, TaskName = "Set Up Server Environment", StartDate = new DateTime(2025,3,10), EndDate = new DateTime(2025,3,14), Duration = 5, Progress = 100, Priority = "Normal", Approved = true, Designation = "DevOps Engineer", EmployeeID = 5023, EmployeeName = "Laura Callahan", Status = "Completed", Description = "Configured Node.js server with clustering, PM2, and logging." },
                new WrapTask { TaskID = 1024, TaskName = "User Authentication Service", StartDate = new DateTime(2025,3,17), EndDate = new DateTime(2025,3,25), Duration = 7, Progress = 100, Priority = "Critical", Approved = true, Designation = "Backend Dev", EmployeeID = 5024, EmployeeName = "Michael Suyama", Status = "Completed", Description = "Implemented JWT-based authentication with refresh tokens and password hashing." },
                new WrapTask { TaskID = 1025, TaskName = "Product Management API", StartDate = new DateTime(2025,3,26), EndDate = new DateTime(2025,4,5), Duration = 9, Progress = 80, Priority = "High", Approved = false, Designation = "API Developer", EmployeeID = 5025, EmployeeName = "Nancy Davolio", Status = "In Progress", Description = "Created CRUD endpoints for product catalog management with filtering and pagination." },
                new WrapTask { TaskID = 1026, TaskName = "Order Processing Service", StartDate = new DateTime(2025,4,7), EndDate = new DateTime(2025,4,18), Duration = 10, Progress = 40, Priority = "High", Approved = false, Designation = "Backend Dev", EmployeeID = 5026, EmployeeName = "Andrew Fuller", Status = "In Progress", Description = "Built order creation, payment integration, and fulfillment workflows." },
                new WrapTask { TaskID = 1027, TaskName = "Reporting & Analytics API", StartDate = new DateTime(2025,4,14), EndDate = new DateTime(2025,4,25), Duration = 10, Progress = 10, Priority = "Normal", Approved = false, Designation = "Data Engineer", EmployeeID = 5027, EmployeeName = "Janet Leverling", Status = "In Progress", Description = "Developed endpoints for sales, performance, and business intelligence analytics." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1029, TaskName = "Write Unit Tests", StartDate = new DateTime(2025,4,21), EndDate = new DateTime(2025,4,30), Duration = 8, Progress = 60, Priority = "Normal", Approved = false, Designation = "QA Engineer", EmployeeID = 5029, EmployeeName = "David William", Status = "In Progress", Description = "Achieved 90% code coverage across all modules using Jest and PyTest." },
                new WrapTask { TaskID = 1030, TaskName = "Integration Testing Phase", StartDate = new DateTime(2025,5,1), EndDate = new DateTime(2025,5,9), Duration = 7, Progress = 0, Priority = "High", Approved = false, Designation = "Test Lead", EmployeeID = 5030, EmployeeName = "Margaret Peacock", Status = "Not Started", Description = "Verified seamless communication between frontend, backend, and third-party services." },
                new WrapTask { TaskID = 1031, TaskName = "Performance & Load Testing", StartDate = new DateTime(2025,5,5), EndDate = new DateTime(2025,5,12), Duration = 6, Progress = 0, Priority = "Critical", Approved = false, Designation = "Performance Tester", EmployeeID = 5031, EmployeeName = "Steven Gray", Status = "Not Started", Description = "Simulated 10,000 concurrent users using JMeter and Gatling." },
                new WrapTask { TaskID = 1032, TaskName = "Security & Vulnerability Scan", StartDate = new DateTime(2025,5,6), EndDate = new DateTime(2025,5,12), Duration = 5, Progress = 0, Priority = "Critical", Approved = false, Designation = "Security Analyst", EmployeeID = 5032, EmployeeName = "Laura Callahan", Status = "Not Started", Description = "Performed OWASP ZAP scans and manual penetration testing." },
                new WrapTask { TaskID = 1033, TaskName = "User Acceptance Testing (UAT)", StartDate = new DateTime(2025,5,12), EndDate = new DateTime(2025,5,16), Duration = 5, Progress = 0, Priority = "High", Approved = false, Designation = "UAT Coordinator", EmployeeID = 5033, EmployeeName = "Robert King", Status = "Not Started", Description = "Conducted final validation with actual end users and stakeholders." }
            }
        },
        ...
        new WrapTask
        {
            ...
            Subtasks = new List<WrapTask>
            {
                new WrapTask { TaskID = 1035, TaskName = "Prepare Production Servers", StartDate = new DateTime(2025,5,19), EndDate = new DateTime(2025,5,21), Duration = 3, Progress = 0, Priority = "High", Approved = false, Designation = "SysAdmin", EmployeeID = 5035, EmployeeName = "Nancy Davolio", Status = "Not Started", Description = "Configured load balancers, SSL certificates, and monitoring tools." },
                new WrapTask { TaskID = 1036, TaskName = "Database Migration", StartDate = new DateTime(2025,5,22), EndDate = new DateTime(2025,5,23), Duration = 2, Progress = 0, Priority = "Critical", Approved = false, Designation = "DBA", EmployeeID = 5036, EmployeeName = "Andrew Fuller", Status = "Not Started", Description = "Executed final schema updates and data migration scripts." },
                new WrapTask { TaskID = 1037, TaskName = "Blue-Green Deployment", StartDate = new DateTime(2025,5,26), EndDate = new DateTime(2025,5,27), Duration = 2, Progress = 0, Priority = "Critical", Approved = false, Designation = "DevOps Lead", EmployeeID = 5037, EmployeeName = "Janet Leverling", Status = "Not Started", Description = "Switched live traffic from old to new version with zero downtime." },
                new WrapTask { TaskID = 1038, TaskName = "Post-Deployment Validation", StartDate = new DateTime(2025,5,28), EndDate = new DateTime(2025,5,30), Duration = 3, Progress = 0, Priority = "High", Approved = false, Designation = "QA Lead", EmployeeID = 5038, EmployeeName = "Anne Dodsworth", Status = "Not Started", Description = "Ran smoke tests and verified all critical features in production." },
                new WrapTask { TaskID = 1039, TaskName = "Project Closure & Celebration", StartDate = new DateTime(2025,5,30), EndDate = new DateTime(2025,5,30), Duration = 1, Progress = 0, Priority = "Normal", Approved = false, Designation = "Project Manager", EmployeeID = 5039, EmployeeName = "Robert King", Status = "Not Started", Description = "Held project closure ceremony, lessons learned session, and team recognition event." }
            }
        }
    };
    }
