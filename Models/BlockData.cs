...
namespace EJ2MVCSampleBrowser.Models
{
    public class BlockData
    {
            ...
            return new List<BlockModel>
            {
                ...
                new BlockModel
                {
                    ...
                    content = new List<object>
                    {
                        ...
                        new { contentType = "Mention", properties = new { userId = "user-john" } }
                    }
                },
                new BlockModel
                {
            ...
            return new List<UserModel>
                {
                    new UserModel
                    {
                        id = "user1",
                        user = "Andrews",
                    avatarUrl = "./../Content/blockeditor/images/andrew.png",
                    },
                    new UserModel
                    {
                        id = "user2",
                        user = "Charlie",
                    avatarUrl = "./../Content/blockeditor/images/charlie.png"
                    },
                    new UserModel
                    {
                        id = "user3",
                        user = "Laura",
                    avatarUrl = "./../Content/blockeditor/images/laura.png",
                    }
                };
        }
        ...
        public static List<TemplatePage> GetPages()
        {
        ...
        private static TemplatePage GetBlankPage()
        {
